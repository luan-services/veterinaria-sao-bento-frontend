            ...
            <div className="w-full max-w-6xl z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Card size="xl" className="flex flex-col gap-4 p-8! border-none shadow-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-xl text-default-fg">Consultas</h3>
                    ...
                    <Card size="xl" className="flex flex-col gap-4 p-8! border-none shadow-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-xl text-default-fg">Vacinação</h3>
                            <p className="text-muted-fg text-sm leading-relaxed">
                    ...
                    <Card size="xl" className="flex flex-col gap-4 p-8! border-none shadow-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-xl text-default-fg">Exames</h3>
                            <p className="text-muted-fg text-sm leading-relaxed">
                    ...
                    <Card size="xl" className="flex flex-col gap-4 p-8! border-none shadow-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-xl text-default-fg">Cirurgias</h3>
                            <p className="text-muted-fg text-sm leading-relaxed">
                    ...
                    <Card size="xl" className="flex flex-col gap-4 p-8! border-none shadow-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-xl text-default-fg">Banho e Tosa</h3>
                            <p className="text-muted-fg text-sm leading-relaxed">
                    ...
                    <Card size="xl" className="flex flex-col gap-4 p-8! border-none shadow-sm">
                        ...
                        <div>
                            <h3 className="font-semibold text-xl text-default-fg">Emergências 24h</h3>
                            <p className="text-muted-fg text-sm leading-relaxed">
