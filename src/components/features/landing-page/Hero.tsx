...
export const Hero = () => {
    return (
            <section className=" w-full flex h-144 lg:h-168 max-w-384 items-center 
                bg-[url('/hero.png')] dark:bg-[url('/hero-dark.png')] bg-no-repeat 
                bg-bottom-right bg-size-[340px] sm:bg-size-[480px] md:bg-size-[600px] lg:bg-size-[760px] xl:bg-size-[880px]"
            >
